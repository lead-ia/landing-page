            ...
            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
                        ...
                        <span className="text-[#130157]">{forKey(TranslationKeys.scope_title_2)}</span>
                    </h2>
                    ...
                    <Card className="border-green-100 bg-green-50/30">
                        <CardHeader>
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <CardTitle className="text-xl text-slate-900">{forKey(TranslationKeys.scope_does_title)}</CardTitle>
                            </div>
                    ...
                    <Card className="border-slate-200 bg-slate-50">
                        <CardHeader>
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <CardTitle className="text-xl text-slate-900">{forKey(TranslationKeys.scope_limits_title)}</CardTitle>
                            </div>
