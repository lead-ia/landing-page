        ...
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 bg-white/30 backdrop-blur-md p-4 rounded-xl shadow-lg border border-white/50">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="font-semibold text-slate-100">{forKey(TranslationKeys.problem_card_title)}</p>
                                        <p className="text-sm text-slate-200">{forKey(TranslationKeys.problem_card_desc)}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:w-1/2">
                        <Badge variant="outline" className="mb-4 border-red-200 text-red-600 bg-red-50">{forKey(TranslationKeys.problem_badge)}</Badge>
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
                            {forKey(TranslationKeys.problem_title_1)} <br />
                            <span className="text-red-500">{forKey(TranslationKeys.problem_title_2)}</span>
                        </h2>
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-slate-900 text-lg">{forKey(TranslationKeys.problem_point_1_title)}</h3>
                                    <p className="text-slate-600">{forKey(TranslationKeys.problem_point_1_desc)}</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="h-10 w-10 rounded-full bg-red-100 flex items-center justify-center text-red-600 shrink-0">
                                ...
                                <div>
                                    <h3 className="font-semibold text-slate-900 text-lg">{forKey(TranslationKeys.problem_point_2_title)}</h3>
                                    <p className="text-slate-600">{forKey(TranslationKeys.problem_point_2_desc)}</p>
                                </div>
                            </div>
                        </div>
