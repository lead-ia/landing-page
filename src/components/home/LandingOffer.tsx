    ...
    <section className="py-20 bg-muted">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <Card className="border-2 border-primary/10 overflow-hidden relative shadow-2xl bg-card p-0">
            ...
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 bg-primary text-primary-foreground flex flex-col justify-center">
                <Badge
                  variant="outline"
                  className="mb-4 text-primary-foreground border-primary-foreground"
                >
                ...
                <div className="flex items-center gap-3 text-sm bg-white/10 p-4 rounded-lg border border-white/10">
                  ...
                  <p>
                    <span className="font-semibold text-primary-foreground">
                      {forKey(TranslationKeys.offer_limited)}
                    </span>{" "}
                    {forKey(TranslationKeys.offer_limited_desc)}
                  </p>
                </div>
              </div>
              ...
              <CardContent className="p-8 md:p-12 flex flex-col justify-center">
                <h3 className="text-xl font-bold text-foreground mb-6">
                  {forKey(TranslationKeys.offer_list_title)}
                </h3>
