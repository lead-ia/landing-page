  ...
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-12">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-6 leading-tight">
            LeadIA — Sua secretária inteligente, humanizada e disponível 24h <br className="hidden md:block" />
            <span className="bg-gradient-to-r bg-clip-text text-transparent from-[#91ebfb] to-primary">Feita por Médicos, para Médicos</span>
          </h1>
          <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
            A secretária virtual realmente humanizada que eleva o padrão do seu consultório.
            Criada por médicos e desenvolvida para médicos que não podem perder pacientes, tempo ou receita.
          </p>
        </div>
      ...
      <div className="flex flex-col gap-4 justify-center items-center mt-8">
        <h1 className="text-2xl md:text-4xl text-center font-extrabold tracking-tight text-slate-900 mb-6 leading-tight">
          Garanta acessso antecipado ao <br className="hidden md:block" />
          <span className="bg-gradient-to-r bg-clip-text text-transparent from-[#91ebfb] to-primary">pré-lançamento</span>
        </h1>

        <Button size="lg" onClick={handleCtaClick}><Rocket /> Quero entrar para o pré-lançamento</Button>
      </div>
